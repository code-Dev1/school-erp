    ...
    $navigation = [
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'ثبت نام شاگرد', 'href' => $safeRoute('student-create'), 'icon' => 'user-plus', 'active' => request()->routeIs('student-create')],
                ['label' => 'سرپرستان', 'href' => $safeRoute('guardian-index'), 'icon' => 'users', 'active' => request()->routeIs('guardian-index')],
                ['label' => 'ثبت سرپرست', 'href' => $safeRoute('guardian-create'), 'icon' => 'plus', 'active' => request()->routeIs('guardian-create')],
        ...
        [
            'label' => 'مدیریت آموزشی',
            'icon' => 'book-open',
            'active' => request()->routeIs('classes.*') || request()->routeIs('subjects.*') || request()->routeIs('timetables.*'),
            'children' => [
                ...
                ['label' => 'سال تعلیمی', 'href' => '#', 'icon' => 'calendar-days', 'active' => false],
            ],
        ],
        [
            'label' => 'استادان و کارمندان',
            'icon' => 'identification',
            'active' => request()->routeIs('teachers.*') || request()->routeIs('staff.*') || request()->routeIs('payroll.*'),
            'children' => [
                ...
                ['label' => 'حاضری کارمندان', 'href' => '#', 'icon' => 'clock', 'active' => false],
            ],
        ],
        [
            ...
            'children' => [
                ['label' => 'حاضری شاگردان', 'href' => '#', 'icon' => 'check', 'active' => false],
                ['label' => 'دستگاه‌های بیومتریک', 'href' => '#', 'icon' => 'cog-6-tooth', 'active' => false],
                ['label' => 'لاگ‌های بیومتریک', 'href' => '#', 'icon' => 'document-chart-bar', 'active' => false],
            ],
        ],
        [
            'label' => 'امتحانات',
            'icon' => 'document-chart-bar',
            'active' => request()->routeIs('exams.*') || request()->routeIs('marks.*'),
            'children' => [
                ['label' => 'برنامه امتحانات', 'href' => '#', 'icon' => 'calendar-days', 'active' => false],
        ...
        [
            'label' => 'مالی',
            'icon' => 'banknotes',
            'active' => request()->routeIs('expenses.*') || request()->routeIs('fees.*') || request()->routeIs('payroll.*'),
            'children' => [
                ['label' => 'فیس شاگردان', 'href' => '#', 'icon' => 'currency-dollar', 'active' => false],
                ['label' => 'مصارف روزانه', 'href' => $safeRoute('expenses.index'), 'icon' => 'banknotes', 'active' => request()->routeIs('expenses.*')],
                ['label' => 'معاشات', 'href' => $safeRoute('payroll.index'), 'icon' => 'currency-dollar', 'active' => request()->routeIs('payroll.*')],
                ['label' => 'گزارش مالی', 'href' => '#', 'icon' => 'chart-bar', 'active' => false],
            ],
        ],
        [
            ...
            'children' => [
                ['label' => 'کتاب‌ها', 'href' => '#', 'icon' => 'book-open', 'active' => false],
                ['label' => 'امانت کتاب', 'href' => '#', 'icon' => 'arrow-path', 'active' => false],
                ['label' => 'مواد درسی', 'href' => '#', 'icon' => 'rectangle-stack', 'active' => false],
            ],
        ],
        [
            'label' => 'گزارش‌ها',
            ...
            'children' => [
                ['label' => 'گزارش شاگردان', 'href' => '#', 'icon' => 'academic-cap', 'active' => false],
                ['label' => 'گزارش حاضری', 'href' => '#', 'icon' => 'check', 'active' => false],
                ['label' => 'گزارش مالی', 'href' => '#', 'icon' => 'banknotes', 'active' => false],
                ['label' => 'گزارش امتحانات', 'href' => '#', 'icon' => 'document-chart-bar', 'active' => false],
            ],
        ],
        [
            'label' => 'تنظیمات سیستم',
