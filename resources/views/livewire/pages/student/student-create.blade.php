<div class="space-y-6">
    <section class="flex flex-col gap-4 rounded-2xl border border-white/70 bg-white/85 p-5 shadow-xl shadow-slate-950/[0.04] backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/70 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-bold tracking-normal text-slate-950 dark:text-white">ثبت نام شاگرد</h2>
        </div>
    ...
    @if ($classOptions === [] || $sectionOptions === [] || $academicYearOptions === [])
        <x-ui.alert variant="warning" title="معلومات پایه کامل نیست">
            برای ثبت شاگرد باید حداقل یک صنف، یک بخش و یک سال تعلیمی در سیستم موجود باشد.
        </x-ui.alert>
    @endif
...
@endpush
        ...
        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
            ...
            <x-ui.button type="submit" icon="check" wire:loading.attr="disabled" wire:target="save">
                <span wire:loading.remove wire:target="save">ذخیره شاگرد</span>
